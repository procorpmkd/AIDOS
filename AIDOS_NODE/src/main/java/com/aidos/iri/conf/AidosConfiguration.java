 ...
 */
public class AidosConfiguration {

    private static final Logger log = LoggerFactory.getLogger(AidosConfiguration.class);
    ...
    static {
        ...
        conf.put(DefaultConfSettings.API_HOST.name(), "139.59.40.96");
